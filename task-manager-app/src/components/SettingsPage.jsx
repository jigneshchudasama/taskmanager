      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white shadow rounded-lg">
            ...
            <div className="px-6 py-4 space-y-4">
              <Can currentUser={currentUser} hasPermissions={['settings:update']}>
              ...
              {!checkPermissions(currentUser.permissions, ['settings:update']) ? (
                <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-md">
                  <p className="text-sm text-yellow-800">You don't have permission to modify these settings.</p>
                </div>
              ) : null}
            </div>
          </div>
